---
title: Steun deze projecten
layout: "single"

partners:
  roosjes-palestina:
    name: Roosjes voor Palestina
    descr: | 
        🌹Doneer een roos ter herdenking aan de Palestijnse kinderslachtoffers.  
        🌹ontvang foto, naam & leeftijd  
        🌹100% van de winst gaat naar Gaza!  
    link: https://www.instagram.com/roosjes_voor_palestina
    img: /images/logo/roosjes-voor-palestina.jpg
    email:
    donate:
        iban:
        bic:
  ...
  palestina-solidariteit:
    name: Palestina Solidariteit vzw
    descr: |
        Palestina Solidariteit vzw is een onafhankelijke vrijwilligersbeweging die op basis van 
        het internationaal recht, respect voor de mensenrechten en de democratische principes 
        opkomt voor een rechtvaardige en duurzame oplossing voor de Israëlisch-Palestijnse kwestie.
    link: https://palestinasolidariteit.be/
    img: /images/logo/palestina-solidariteit.png
    email: 
    donate:
        iban: BE64 5230 8014 8852
        bic: TRIOBEBB
        link: https://palestinasolidariteit.be/steun-palestina-solidariteit/
